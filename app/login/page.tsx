      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-16 relative overflow-hidden"
        ...
        <div className="relative z-10">
          <h1 className="text-5xl leading-tight mb-6"
            ...
            Everything<br />in its<br />right place.
          </h1>
          <p className="text-base" style={{ color: '#a89e8e' }}>
            Capture tasks. Set priorities.<br />Meet every deadline.
          </p>
        </div>

        <p className="text-xs" style={{ color: '#4a4540' }}>
          © {new Date().getFullYear()} Todos
        </p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          <div className="mb-8 animate-fade-up">
            <h2 className="text-2xl font-semibold mb-1" style={{ color: 'var(--text-primary)', fontFamily: 'var(--font-display)' }}>
              Welcome back
            </h2>
